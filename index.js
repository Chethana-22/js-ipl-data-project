...
const getExtraRunsConcededPerTeam2016 = require('./src/server/3-extraRuns.js');
const getTop10BowlersEconomy = require('./src/server/4-top10Bowlers.js');
...
writefile('src/public/output/3-extraRunsPerTeam2016.json', JSON.stringify(getExtraRunsConcededPerTeam2016(matches, deliveries)), null,2);
writefile('src/public/output/4-top10Economy.json', JSON.stringify(getTop10BowlersEconomy(matches, deliveries)), null, 2);
writefile('src/public/output/5-wonTossAndMatch.json',JSON.stringify(getWonTossAndMatch(matches)), null , 2);
writefile('src/public/output/6-playerOfTheMatch.json',JSON.stringify(getHighestNumberOfPlayerOfMatch(matches)), null, 2);
